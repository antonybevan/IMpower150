/* =====================================================================
   GENERATED PROGRAM FOR DERIVATION RULE: RULE_PFS_AVAL_BICR
...
%derive_date_diff(outds=work.out_pfs_bicr, inds=work.raw_data, targetvar=AVAL, startvar=RANDDT, endvar=PFSDT_BICR);
